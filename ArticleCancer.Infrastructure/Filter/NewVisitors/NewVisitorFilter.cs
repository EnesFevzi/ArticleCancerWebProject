...
namespace ArticleCancer.Infrastructure.Filter.NewVisitors
{
    public class NewVisitorFilter : IAsyncActionFilter
    {
        private readonly IUnıtOfWork _unitOfWork;

        public NewVisitorFilter(IUnıtOfWork unitOfWork)
        {
