...
namespace ArticleCancer.Infrastructure.Filter.VideoBlogVisitors
{
    public class VideoBlogVisitorFilter : IAsyncActionFilter
    {
        private readonly IUnıtOfWork _unitOfWork;

        public VideoBlogVisitorFilter(IUnıtOfWork unitOfWork)
        {
