...
$(document).ready(function () {
    ...
    var totalNewCountUrl = app.Urls.totalNewCountUrl;
    $.ajax({
        type: "GET",
    ...
    $.ajax({
        type: "GET",
        url: totalNewCountUrl,
        dataType: "json",
        success: function (data) {
            $("h3#totalNewCount").append(data);
        },
        error: function () {
            toastr.error("Haber Analizleri yüklenirken hata oluştu", "Hata");
        }
